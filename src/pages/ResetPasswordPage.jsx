...
export default function ResetPasswordPage({ setCurrentPage }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // A Supabase recovery link creates an authenticated recovery session.
      // End that session after the password change so the customer signs in
      // normally with the new password instead of remaining authenticated.
      await logout();
